...
class Cadastro {
  ...
  Cadastro(this.nome, {this.curso,this.email,this.idade,this.statuscovid, this.reference});
  ...
  factory Cadastro.fromJson(Map<dynamic, dynamic> json) => _CadastroFromJson(json);

  Map<String, dynamic> toJson() => _SugestaoToJson(this);
}

Cadastro _CadastroFromJson(Map<dynamic, dynamic> json) {
  return Cadastro(json['nome'] as String,
...
Map<String, dynamic> _SugestaoToJson(Cadastro instance) =>
    <String, dynamic>{
      'nome': instance.nome,
